            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Input MSISDN(TW)" name="msisdn_tw" id="msisdn_tw" />
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Input MSISDN(ID)" name="msisdn_id" id="msisdn_id" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <select class="form-control selectpicker" name="id_type" id="id_type">
                            ...
                            <option value="{{ $type }}" {{ $type == $customerIdentity['id_type'] ? 'selected' : '' }}>
                                {{ strtoupper($type) }}
                            </option>
                            @endforeach
                        </select>
                        <input type="text" class="form-control" placeholder="Input ID Number" name="id_number" id="id_number" />
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <i class="la la-calendar"></i>
                            </span>
                        </div>
                        <input type="text" class="form-control" placeholder="YYYY-MM-DD" name="expdate" id="expdate" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Input No. ARC" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Input Other Phone" name="other_phone" id="other_phone" />
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="YYYY-MM-DD" name="activationDate" id="activationDate" />
                    </div>
                </div>
            </div>
            <div class="col-md-4">
